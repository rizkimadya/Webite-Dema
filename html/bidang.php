...
<html lang="en">
  <head>
    ...
    <!-- link css -->
    <link rel="stylesheet" href="../css/bidangg.css">
  ...
  <body>
    ...
    <section id="bidang">
        <div class="container">
            ...
            <div class="row d-flex justify-content-center ketua">
                <div class="col-lg-4 col-md-12 text-center">
                    <div class="card">
                        <img src="../img/ketua.jpg" alt="">
            ...
            <div class="row d-flex justify-content-center wakil_ketua">
                <div class="col-lg-4 col-md-12 text-center">
                    <div class="card">
                        <img src="../img/wk1.jpg" alt="">
                        <div class="card_title">
                            <h4>Wakil Ketua 1</h4>
                            <p>A. Afif Fathoni</p>
                        </div>
                ...
                <div class="col-lg-4 col-md-12 text-center">
                    <div class="card">
                        <img src="../img/wk2.jpg" alt="">
                        <div class="card_title">
                            <h4>Wakil Ketua 2</h4>
                            <p>Muh. Thafdil Wirawan S.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 text-center">
            ...
            <div class="row d-flex justify-content-center sekretaris">
                <div class="col-lg-4 col-md-12 text-center">
                    <div class="card">
                        <img src="../img/atiqa.jpg" alt="">
                        <div class="card_title">
                ...
                <div class="col-lg-4 col-md-12 text-center">
                    <div class="card">
                        <img src="../img/tenri.jpg" alt="">
                        <div class="card_title">
                            <h4>Wakil Sekretaris 1</h4>
                            <p>Andi Tenri Pada</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 text-center">
                    <div class="card">
                        <img src="../img/nursul.jpg" alt="">
                        <div class="card_title">
                            <h4>Wakil Sekretaris 2</h4>
                            <p>Nursul Hijriani</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row d-flex justify-content-center bendahara">
                <div class="col-lg-4 col-md-12 text-center">
                    <div class="card">
                        <img src="../img/user.png" alt="">
                        <div class="card_title">
                            <h4>Bendahara Umum</h4>
                            <p>Sri Hasruni Nengsi H.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-12 text-center">
