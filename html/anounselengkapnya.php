<?php
    ...
    $table_peng = mysqli_query($koneksi, "SELECT * FROM table_pengumuman ORDER BY id DESC");
?>
...
<html lang="en">
  <head>
    ...
    <!-- link css -->
    <link rel="stylesheet" href="../css/anounselengkap.css">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    ...
                    <h1 class="title"><?= $table_pengumuman['judul_pengumuman'];?></h1>
                    <h4 class="subtitle ckeditor" id="ckedtor"><?= $table_pengumuman['isi_pengumuman'];?></h4>
                    <form action="previewpdf.php" method="post">
                        <input type="hidden" name="id" value="<?= $table_pengumuman['id']; ?>">
                        <button type="submit"><i class="bi bi-cloud-arrow-down-fill"></i> DOWNLOAD LAMPIRAN</button>
                    </form>
                </div>
            </div>
        </div>
    </section>
    <!-- akhir detail pengumuman -->
