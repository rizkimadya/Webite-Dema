<?php
    ...
    $table_pengumuman = query("SELECT * FROM table_pengumuman ORDER BY id DESC");
...
<html lang="en">
  <head>
    ...
    <!-- link css -->
    <link rel="stylesheet" href="../css/anouncemen.css">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../html/anouncement.php">Pengumuman</a>
                </li>
                <li class="nav-item">
    ...
    <section id="pengumuman">
        <div class="container">
            ...
            <div class="row d-flex cards">
                ...
                ?>
                <div class="col-lg-4 col-md-12 mt-4 deskripsi">
                    <div class="card">
