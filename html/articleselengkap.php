<?php
    ...
    $table_art = query_single("SELECT * FROM table_artikel WHERE id_artikel='$id_artikel'");
    $table_artikel = mysqli_query($koneksi, "SELECT * FROM table_artikel ORDER BY id_artikel DESC");
...
<html lang="en">
  <head>
    ...
    <!-- link css -->
    <link rel="stylesheet" href="../css/articleselengkapp.css">
  ...
  <body>
    ...
    <section id="detail">
        <div class="container">
        <input type="hidden" name="id_artikel" value="<?= $table_art['id_artikel'];?>">
            <div class="row">
                <div class="col-12 text-center">
                    <h1>Artikel Kegiatan</h1>
                    <img src="../foto/<?= $table_art['gambar']; ?>">
                </div>
            </div>
            <div class="row">
                <div class="col-10 text-center m-auto">
                    <div class="isi">
                        <h3><?= $table_art['judul_artikel'];?></h3>
                        <div class="card">
                            <p class="ckeditor" id="ckedtor"><?= $table_art['isi_artikel'];?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="artikel"> 
        <div class="container">
            ...
            <div class="row cards">
                <?php foreach ($table_artikel as $artikel): ?>
