<?php
    ...
    $table_artikel = query("SELECT * FROM table_artikel ORDER BY id_artikel DESC");
...
<html lang="en">
  <head>
    ...
    <!-- link css -->
    <link rel="stylesheet" href="../css/artikell.css">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mb-2 mb-lg-0 ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="../html/article.php">Artikel</a>
                </li>
                <li class="nav-item">
